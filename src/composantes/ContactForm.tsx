...
export default function ContactClient() {
  ...
  return (
    <div
      className={`max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 transition-opacity duration-1000 ${
        visible ? "opacity-100" : "opacity-0"
      }`}
    >
      {/* Header */}
      <header className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 mb-4 animate-fadeIn">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-cyan-700 text-white font-bold py-3 rounded-lg hover:bg-cyan-600 hover:scale-105 transition-transform duration-200"
          >
            <Send className="w-5 h-5" /> Envoyer votre demande
          </button>
        </form>
        ...
        <div className="space-y-8 animate-fadeIn delay-500">
          <div className="bg-white shadow-lg rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-cyan-700 mb-4">Mes coordonnées directes</h2>
